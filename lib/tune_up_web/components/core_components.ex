defmodule TuneUpWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TuneUpWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TuneUpWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def date_range_picker(assigns) do
    ~H"""
    <.live_component
      module={TuneUpWeb.Components.DateRangePicker}
      label={@label}
      id={@id}
      form={@form}
